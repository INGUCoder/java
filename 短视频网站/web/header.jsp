    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-7">
            <ul class="top-bar-left">
                ...
                <li>
                    <a href="http://www.russ-mind.top" target="_blank">
        ...
        <div class="col-md-offset-3">
            <span class="top-bar-right pull-right">喜欢轮滑, 就来<span style="color: red">罗曼尼</span> (www.russ-<span
                    style="color: red">mind</span>.top)</span>
        </div>
    </div>
</div>
<!--导航-->
<nav class="navbar navbar-default navbar-lk">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.jsp" style="margin-left: 180px;padding-right: 30px;">
                <img src="images/lm_logo_sm.jpg" alt="罗曼尼Logo" width="220">
            </a>
            ...
            <a href="${ctx}/login.jsp" style="line-height:95px; height: 95px;font-size: 18px; color: #0a628f">
                发布文章
            </a>
        </div>
    </div>
...
<section id="lk_blog_one">
    ...
    <div class="one-right">
        <h1>Romani roller Skating</h1>
        <span>喜欢轮滑,就来罗曼尼吧!</span>
        <div style="position: relative;" class="one-bottom">
            <button>关注我们</button>
            <img src="images/ewm2.png" alt="" width="100" class="one-ewm">
        </div>
    </div>
</section>
    ...
    $(function () {
        ...
        $.post("${pageContext.request.contextPath}/article_getCategory.action", {"parentId": 0}, function (data) {
            ...
            $(data).each(function (i, obj) {
                $("#nav").append("<li class='active'><a href='index.jsp?parentId=" + obj.cid + "'>" + obj.name + "</a></li>");
            });
