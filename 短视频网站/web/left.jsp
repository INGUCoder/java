...
<ul>
    <li><a href="${pageContext.request.contextPath}/Category" target="mainFrame"><i></i>分类管理</a></li>
    <li><a href="${pageContext.request.contextPath}/videoPageList" target="mainFrame"><i></i>视屏管理</a></li>
    <li></i><a href="${pageContext.request.contextPath}/userList" target="mainFrame"><i></i>用户管理</a></li>
</ul>
