...
var userState="<%=request.getParameter("userState")%>";
	...
	function loding(pageNum){
		$.ajax({
			type:"post",
			url:"http://"+test+"/EnterpriseInfoManage/consultationInfoController/getConsultation?pageNum="+pageNum+"&pageSize="+pageSize,
			dataType:"json",
			success:function(data){
				var html ="";
				$.each(data,function(index,item){
					html +="<tr><td>"+item.street_name+"</td><td>"+item.fixed_telephone+"</td><td>"+item.mail_bo+"</td><td>"+item.postal_address+"</td></tr>";
				})
				if(html==""){
	...
	function fenYe(){
       	$.ajax({
       		async:false,
       		type:"post",
       		url:"http://"+test+"/EnterpriseInfoManage/consultationInfoController/getLen",
       		success:function(data){
       			len=data;	
       		}
       	})
