		...
		$.ajax({
			...
			success:function(data){
				...
				$.each(data,function(index,item){
					...
					html +="<tr><td>"+enterpriseName+"</td><td>"+enterpriseLegalRepresentative+"</td><td>"+item.mailerTelephone+"</td><td>"+enterpriseArea+"</td><td>"+item.mailerName+"</td><td>"+item.mailTime+"</td><td>"+item.mailNumber+"</td></tr>";
					 enterpriseArea="";
					 enterpriseName="";
