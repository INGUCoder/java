...
var userState="<%=request.getParameter("userState")%>";
	...
	function addUser(){
		alert($("#enterpriseid").val());
	  	$.ajax({
       		async:false,
       		type:"post",
       		url:"http://"+test+"/EnterpriseInfoManage/userController/add",
       		dataType: "json",
       		data:{
...
<body>
	...
	<table>
		<thead>
			<tr class="head_text"  height="50px"><td colspan="2" style="padding-left: 130px">添加用户</td></tr><br/><br/>
		</thead>
		<tbody>		
