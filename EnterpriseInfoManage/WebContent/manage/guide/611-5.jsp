			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<img class="img-rounded" width="100%"  src="image/611-5-1.png" />
							<img class="img-rounded" width="100%"  src="image/611-5-2.png" />
							<img class="img-rounded" width="100%"  src="image/611-5-3.png" />
						</div>
					</div>
