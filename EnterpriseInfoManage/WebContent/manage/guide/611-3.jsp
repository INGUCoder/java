			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<div class="panel panel-success">
						<div class="panel-heading">
							<h3 class="panel-title">
								<b>有财务报表的非一套表企业法人主要财务指标摘抄渠道一览表</b>
							</h3>
						</div>
						<div class="panel-body">
							<img class="img-rounded" width="100%"  src="image/611-3-1.png" />
						</div>
						<div class="panel-heading">
							<h3 class="panel-title">
								<b>没有财务报表的企业法人主要经济指标填报方法</b>
							</h3>
						</div>
						<div class="panel-body">
							<img class="img-rounded" width="100%"  src="image/611-3-2.png" />
							<img class="img-rounded" width="100%"  src="image/611-3-3.png" />
							<img class="img-rounded" width="100%"  src="image/611-3-4.png" />
							<img class="img-rounded" width="100%"  src="image/611-3-5.png" />
						</div>
					</div>
